...
int main(int argc, const char * argv[]) {
    @autoreleasepool {
        /*
         ...
         原文链接：https://blog.csdn.net/lovelion/article/details/7819266
         */
        // insert code here...
        MovieTicket *movieTicket = [[MovieTicket alloc] init];
        CGFloat originalPrice = 60;
        CGFloat currentPrice = 0;
        movieTicket.price = originalPrice;
        NSLog(@"原始价格:%.2f", originalPrice);
        
        NSObject <Discount> * discount = [[StudentDiscount alloc] init];
        movieTicket.discount = discount;
        currentPrice = [movieTicket calculatePrice];
        
        NSLog(@"折后价:%.2f", currentPrice);
    }
    return 0;
}
